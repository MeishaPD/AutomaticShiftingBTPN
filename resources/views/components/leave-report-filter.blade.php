        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div class="flex items-end">
                <label class="flex items-center space-x-2">
                    <input type="checkbox" name="only_with_leaves" value="1" {{ $onlyWithLeaves ? 'checked' : '' }}>
                    <span class="text-xs text-gray-700">Show only employees with leaves</span>
                </label>
            </div>
        </div>
