...
<main class="flex-grow py-6 sm:py-8">
    <div class="container mx-auto px-4 sm:px-6">
        <div class="mb-8 sm:mb-12">
            <div class="bg-[#F5F5F5] text-black px-3 sm:px-4 py-2 rounded-md text-xs sm:text-sm font-medium tracking-wide inline-block shadow-[inset_0_4px_4px_rgba(0,0,0,0.25)]">
        ...
        <div class="flex flex-col space-y-4 sm:space-y-6 max-w-xs sm:max-w-md mx-auto">
            <a href="#" class="bg-white border border-gray-200 rounded-lg shadow-md p-3 sm:p-4 flex items-center space-x-3 sm:space-x-4 hover:shadow-lg hover:-translate-y-1 transition-all duration-200 text-decoration-none group">
                ...
                <span class="text-gray-700 font-medium group-hover:text-gray-900 text-sm sm:text-base">KARYAWAN ONBOARDING</span>
            </a>
            ...
            <a href="#" class="bg-white border border-gray-200 rounded-lg shadow-md p-3 sm:p-4 flex items-center space-x-3 sm:space-x-4 hover:shadow-lg hover:-translate-y-1 transition-all duration-200 text-decoration-none group">
                ...
                <span class="text-gray-700 font-medium group-hover:text-gray-900 text-sm sm:text-base">CUTI ONBOARDING</span>
            </a>
            ...
            <a href="#" class="bg-white border border-gray-200 rounded-lg shadow-md p-3 sm:p-4 flex items-center space-x-3 sm:space-x-4 hover:shadow-lg hover:-translate-y-1 transition-all duration-200 text-decoration-none group">
                ...
                <span class="text-gray-700 font-medium group-hover:text-gray-900 text-sm sm:text-base">REQUEST SHIFTING</span>
            </a>
            ...
            <a href="#" class="bg-white border border-gray-200 rounded-lg shadow-md p-3 sm:p-4 flex items-center space-x-3 sm:space-x-4 hover:shadow-lg hover:-translate-y-1 transition-all duration-200 text-decoration-none group">
                ...
                <span class="text-gray-700 font-medium group-hover:text-gray-900 text-sm sm:text-base">REPORT</span>
            </a>
        </div>
    </div>
</main>
